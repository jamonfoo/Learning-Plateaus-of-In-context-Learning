...
sample_path=os.path.join(sample_dir,f"test_0.npz")
dir_path=os.path.join(output_dir,config["name"]+f"_{args.mode}")
k_epoch=1
T_epoch=100
...
if __name__=="__main__":
    ...
    json.dump(rst,open(os.path.join(dir_path,f"test_context.json"),"w"))    